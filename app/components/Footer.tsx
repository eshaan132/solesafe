      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Protecting your athletic footwear, enhancing your performance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/sizing" className="text-gray-600 hover:text-blue-600">
                  Sizing Guide
                </Link>
              </li>
              <li>
                <Link href="/care" className="text-gray-600 hover:text-blue-600">
                  Care Instructions
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} SoleSafe. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
